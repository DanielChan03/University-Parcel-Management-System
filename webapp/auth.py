...
def login():
    ...
    return render_template("StudentStaff/StudentStaffLogin.html", user=current_user)
...
def sign_up():
    ...
    return render_template("StudentStaff/StudentStaffSign_up.html", universities=universities, user=current_user)